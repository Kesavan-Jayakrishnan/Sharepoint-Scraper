...
- Schema includes provenance locator strategy so extraction remains auditable even when Doc AI does not return exact cell references.

- Schema supports column-name selectors (preferred) and range selectors as fallback for tabular extraction.
